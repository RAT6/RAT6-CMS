...
$dirsArray = array(
	RATDATAPATH, 
	RATDATAOTHERPATH, 
	RATDATAOTHERPATH.'loRAT/', 
	RATDATAPAGESPATH, 
	RATDATAUPLOADPATH, 
	RATTHUMBNAILPATH, 
	RATBACKUPSPATH, 
	RATBACKUPSPATH.'other/', 
	RATBACKUPSPATH.'pages/',
	RATBACKUPSPATH.'zip/',
	RATBACKUSERSPATH,
	RATUSERSPATH
);
...
foreach ($dirsArray as $dir) {
	$tmpfile = RATADMININCPATH.'tmp/tmp-404.xml';
...
$api_file = RATDATAOTHERPATH.'authorization.xml';

if (! file_exists($api_file)) {
	if (defined('RATUSECUSTOMSALT')) {
		$saltval = sha1(RATUSECUSTOMSALT);
	} else {
