...
?>
		<div id="footer">
      	...
      	?>
      		<p>&copy; 2009-<?php echo date('Y'); ?> <a href="http://get-simple.info/" target="_blank" >RAT6 CMS</a> &ndash; <?php echo i18n_r('VERSION') .' '. $site_version_no; ?></p>
      	</div>
      	<div class="RATlogo" >
	      	<a href="http://get-simple.info/" target="_blank" ><img src="template/images/RAT6_logo.gif" alt="RAT6 Content Management System" /></a>
	      </div>
      	<div class="clear"></div>
