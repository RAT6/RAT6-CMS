...
if (file_exists(RATTHEMESPATH.'admin.xml')) {
	#load admin theme xml file
	$theme = getXML(RATTHEMESPATH.'admin.xml');
...
.header {
	...
	#settinRAT .wrapper .nav li a.settinRAT,
	...
	#load .wrapper .settinRAT li a.settinRAT,
...
#footer .RATlogo a:link,#footer .RATlogo a:visited  {
...
#footer .RATlogo a:hover  {opacity:1}
.toggle {display:none;}
...
#index .RATlogo,
#resetpassword .RATlogo {display:none;}
