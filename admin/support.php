...
if(isset($_POST['submitted'])) {
	$success = i18n_r('SETTINRAT_UPDATED').'. <a href="support.php?undo&nonce='.get_nonce("restore", "support.php").'">'.i18n_r('UNDO').'</a>';
}
...
<?php get_template('header', cl($SITENAME).' &raquo; '.i18n_r('SUPPORT') ); ?>
	...
	<h1><a href="<?php echo $SITEURL; ?>" target="_blank" ><?php echo cl($SITENAME); ?></a> <span>&raquo;</span> <?php i18n('SUPPORT');?> <span>&raquo;</span> <?php i18n('SETTINRAT');?></h1>
...
<div class="bodycontent">
	...
	<div id="maincontent">
		...
		<ol>
			...
			?>
			<?php if (file_exists($path . 'loRAT/failedlogins.log')) { ?>
