 ...
 * For: support.php
*/
"SETTINRAT_UPDATED"	=> 	"Your settinRAT have been updated",
"UNDO" 							=> 	"Undo",
"SUPPORT" 					=> 	"Support",
"SETTINRAT" 					=> 	"SettinRAT",
"ERROR" 						=> 	"Error",
"BTN_SAVESETTINRAT" 	=> 	"Save SettinRAT",
 ...
 * For: settinRAT.php
*/
"GENERAL_SETTINRAT"	=>	"General SettinRAT",
"WEBSITE_SETTINRAT"	=>	"Website SettinRAT",
...
"TAB_SETTINRAT"			=>	"<em>S</em>ettinRAT",
...
/* 
 * For: sidebar-settinRAT.php
*/
"SIDE_GEN_SETTINRAT"	=>	"General <em>S</em>ettinRAT",
...
*/
"ER_PWD_CHANGE"			=>	"Don't forget to <a href=\"settinRAT.php#profile\">change your password</a> from that random generated one you have now...",
...
"ER_SETTINRAT_UPD"		=>	"Your settinRAT have been updated",
"ER_OLD_RESTORED"		=>	"Your old settinRAT have been restored",
