	...
	<div id="maincontent">
		<div class="main">
			...
			<ul>
				...
				<li><a href="settinRAT.php"><?php i18n('GENERAL_SETTINRAT'); ?></a></li>
				<li><a href="theme.php"><?php i18n('THEME_MANAGEMENT'); ?></a></li>
				<?php exec_action('welcome-link'); ?>
			</ul>
			<ul>
				<li><a href="http://www.facebook.com/pages/RAT6/196237143792761/wiki/"><?php echo str_replace(array("<em>","</em>"), '', i18n_r('SIDE_DOCUMENTATION') ); ?></a></li>
